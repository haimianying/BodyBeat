...
#define FRAME_LENGTH 513//<-----------------------the number of total features/values received by the native layer
...
#define TOTAL_FEAT 14//<--------------------the number of total frame-level feature  extracted by the native layer
